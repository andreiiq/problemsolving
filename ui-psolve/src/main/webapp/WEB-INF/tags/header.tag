...
<div class="container-fluid">
	...
	<div class="collapse navbar-collapse" id="defaultNavbar1">
		<form:form id="header-search-form"
			class="navbar-form navbar-left form form-vertical" role="search"
			method="get" action="/search">
			<div class="form-group">
				<input id="header-search-input" name="name" list="search-results"
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown"><a href="${notificationsURL}"
				...
				role="button" aria-expanded="false">Notifications<span class="new-notifications-number"></span><span
					class="caret"></span></a>
